...
## POSTERIOR ##
path_post <- paste( home_dir,"sum_analyses/posterior/conc/fosscal/GBM/",
                    sep = "" )
...
pdf( paste( outchecks_dir,
            "ESS_and_chains_convergence/Convergence_plot_post_conc_GBM_fosscal.pdf",
            sep = "" ),
     paper = "a4" )
plot_convergence( name_dir_dat = "Post - Con+GBM+fosscal",
