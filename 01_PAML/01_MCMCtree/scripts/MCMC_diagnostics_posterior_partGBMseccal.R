...
## POSTERIOR ##
path_post <- paste( home_dir,"sum_analyses/posterior/part/seccal/GBM/",
                    sep = "" )
...
pdf( paste( outchecks_dir,
            "ESS_and_chains_convergence/Convergence_plot_post_part_GBM_seccal.pdf",
            sep = "" ),
     paper = "a4" )
plot_convergence( name_dir_dat = "Post - Part+GBM+seccal",
